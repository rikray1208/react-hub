...
const CardBookMark: React.FC<CardBookProps> = ({onClick, isHover, isActive}) => {

    return (
            <CSSTransition in={isHover} timeout={500} classNames='bookMark'>
                <svg
                     onClick={onClick}
...
// @apply absolute right-4 top-[-16px]
